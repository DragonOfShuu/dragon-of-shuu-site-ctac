                ...
                <MjmlSection paddingBottom={spacing.s11} cssClass="gutter">
                    <MjmlColumn>
                        <Heading cssClass="h2" paddingBottom={spacing.s6}>
                            <span style={{ color: colors.green300 }}>●</span>{" "}
                        ...
                        >
                            ...
                            <span className="code">emails/previews</span>. Keep
                            it open while you build your emails and it’ll live
                            reload as you develop. To see it in action with this
                            preview, make a change to{" "}
                            <span className="code">
                                emails/previews/Welcome.tsx
                            </span>
                            . You can deploy your Mailing server to Vercel or
                            Netlify to share the Preview Viewer with your team.
                        </Text>
                ...
                <MjmlSection paddingBottom={spacing.s11} cssClass="gutter">
                    <MjmlColumn>
                        ...
                        <Text cssClass="p" paddingBottom={spacing.s7}>
                            Mailing Platform gives you analytics and drop-in
                            unsubscribe links + subscription preferences, so
                            your users can control what email they receive. When
                            you try to send an email to an unsubscribed user,
