...
const CodingPatternFeature = () => {
    return (
        <div
            className={`${fullscreenStyles.fullscreenFeatureMargin} py-4 flex flex-col justify-center items-center`}
        >
            <div className={`max-w-[1200px] mx-auto sm:px-4`}>
                ...
                <p className={`text-center text-xl mb-8`}>
                    I like to follow many rules of programming to make my code
                    easier for others and myself to read, as well as making my
                    code sharper and more reusable.
                </p>
            </div>
            <div
            ...
            >
                ...
                >
                    <p>
                        I focus on writing DRY code. DRY code makes your code
                        consistent, and easier to read.
                    </p>
                </PatternDivider>
                <PatternDivider title={`Early Returns`}>
                    <p>
                        Early returns avoid your code from being too long, and
                        allows you to avoid repetitive if/else statements too.
                    </p>
                </PatternDivider>
                <PatternDivider title={`NO if/else`}>
                    <p>
                        Having large if/else statement blocks make your code
                        hard to follow. Removing if/else statements is easy when
    ...
    return (
        <div className={props.className}>
            <Viewable3dDiv className={`h-full`} maxTurn={20}>
                <div
                    className={`size-full rounded-md border-2 border-orange-500 bg-orange-950 bg-opacity-50 p-4 max-w-96`}
                >
                    <h2>{props.title}</h2>
                    {!props.subtitle ? (
                        <></>
                    ) : (
                        <h3 className={`mt-1`}>{props.subtitle}</h3>
                    )}
                    <div className={`mb-4`} />
                    {props.children}
                </div>
