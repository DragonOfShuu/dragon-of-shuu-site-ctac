        ...
        <>
            <PageHeader fullscreen>
                <div className={`h-screen flex flex-col size-full p-4 md:p-14`}>
                    ...
                    <div
                        className={`flex flex-col md:flex-row-reverse items-center gap-2 grow basis-0 min-h-0 xl:gap-6 self-center md:max-w-[1200px]`}
                    >
                        <Image
                            src={dragonOfShuu}
                        ...
                        />
                        <h1
                            className={`text-center md:text-left lg:text-6xl font-striking my-auto`}
                        >
