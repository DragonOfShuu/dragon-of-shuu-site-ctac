...
export type Modes = 'ghost' | 'available' | 'found' | 'finding' | 'barrier' | 'path' 
...
export function getTrudgeCost(trudge: Trudge) {
    const multiplier = 1;
    switch (trudge) {
        case Trudge.ASPHALT: return 1*multiplier;
        case Trudge.GRASS: return 2*multiplier;
        case Trudge.MUD: return 4*multiplier;
        case Trudge.WATER: return 10*multiplier;
        default: return 2;
    }
}
