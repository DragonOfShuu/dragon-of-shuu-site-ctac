...
const Settings = (props: SettingsProps) => {
    ...
    return (
        <>
            <ToolBarButton
                onClick={() => diaglogBox.current?.showModal()}
                alt="Settings"
                image={gearIcon}
            />

            <BaseDialog
                dialogRef={diaglogBox}
                topBar={[
                    {
                        alt: "Reset Settings",
                        click: () => sDispatch({ type: "reset" }),
                        image: Rotate,
                    },
                ]}
            >
                <RangeInput
                    ...
                    onChange={(e) =>
                        sDispatch({
                            type: "update",
                            data: {
                                pathRevealSpeed: Number.parseFloat(
                                    e.target.value,
                                ),
                            },
                        })
                ...
                <RangeInput
                    ...
                    onChange={(e) =>
                        sDispatch({
                            type: "u",
                            algoSpeed: Number.parseFloat(e.target.value),
                        })
                    }
                />
                <label>
                    <input
                        ...
                        max={30}
                        onBlur={(e) => {
                            const potentialValue = Number.parseFloat(
                                e.target.value,
                            );
                ...
                <CheckBox
                    ...
                    onChange={(e) =>
                        sDispatch({
                            type: "u",
                            normalizeDirection: e.target.checked,
                        })
                    }
                ...
                <CheckBox
                    ...
                    onChange={(e) =>
                        sDispatch({
                            type: "u",
                            canPerformDiagonals: e.target.checked,
                        })
                    }
