    ...
    return (
        <>
            <div 
                ...
                >
                <h1 style={{transform: `translateX(${shiftX}px) translateY(${shiftY}px)`}} className={`transition-all`}>
                    NOT FOUND
                </h1>
            ...
            <div className={`absolute inset-0 -z-10 flex items-center justify-center`}>
                <p className={`text-[12rem] font-bold text-orange-500 opacity-10`}>
                    404
                </p>
            </div>
            <div className={`absolute inset-0 -z-20 overflow-hidden`}>
                <div className={`${styles.repeatingBackground} ${styles.movingBackground}`}>
