...
/**
 * @deprecated This export is deprecated and should no longer be used.
 */
// const extraProjects: { [name: string]: ProjectType } = {
//     DucklingScript: {
//         name: "DucklingScript",
//         description:
//             "A compiler for a programming language for injecting keystrokes. Originally based on Rubber Ducky 1.0",
...
//         name: "Quackinter",
//         description:
//             "An interpreter for reading Rubber Ducky 1.0 and executing it directly on the machine.",
...
//         description:
//             "Middleware that ingests 4G/5G metric data from Cradlepoint's NetCloud solution and stores it in an Elasticsearch database.",
...
//         name: "Action Logger",
//         description:
//             "A simple action logger that tells you what keys are being held down and released and when.",
...
//         description:
//             "Store names and quotes, and randomly select the names for a drawing!",
...
//         name: "Paradigm",
//         description:
//             "Create text hotkeys that inject full text and sentences with placeholders",
...
//         description:
//             "Tic Tac Toe, but you play in 3 dimensions! There are higher board levels, and lower board levels.",
...
//         description:
//             "Chess, but you have to completely annihilate the other team.",
