...
export const epicFormReducer = (oldState: EpicFormDataType, action: EpicFormDataAction): EpicFormDataType => {
    ...
    switch (action.type) {
        ...
        case 'removeError': {
            if (!Object.keys(newState.errors).includes(action.param)) return oldState;
